...
procedure Advent_Of_Code.Y2025.Day_7.Part_2 is
   Input_File : Ada.Text_IO.File_Type;
   Input_File_Path : constant String := "src/2025/Day7/Part2.txt";
...
begin
   ...
   Result := Calculate_How_Many_Timelines_The_Beam_Ends_Up_On 
     (Beam_Start_Index   => Beam_Start_Index,
      Splitter_Positions => Splitter_Matrix);
   
   Ada.Text_IO.Put_Line ("Beam Timelines:" & Result'Image);
   
   Ada.Text_IO.Close 
     (File => Input_File);
end Advent_Of_Code.Y2025.Day_7.Part_2;
