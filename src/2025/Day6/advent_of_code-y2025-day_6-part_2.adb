...
procedure Advent_Of_Code.Y2025.Day_6.Part_2 is
   Input_File : Ada.Text_IO.File_Type;
   Input_File_Path : constant String := "src/2025/Day6/Part2.txt";
...
begin
   ...
   Transpose_Numbers_Right_To_Left:
   for Group in Problem_Data.First_Index .. Problem_Data.Last_Index loop
      declare
         Numbers_Copy : Integer_Vectors.Vector := Problem_Data (Group).Numbers;
         Transposed_Numbers : Integer_Vectors.Vector;
         Temp : Long_Long_Long_Integer;
      begin
         loop
            Temp := 0;
            for E of Numbers_Copy loop
               if not (E mod 10 = 0) then
                  Temp := Temp * 10 + E mod 10;
               end if;
               E := E / 10;
            end loop;
            ...
            Transposed_Numbers.Append 
              (New_Item => Temp);
         end loop;
         
         Problem_Data (Group).Numbers := Transposed_Numbers;
      end;
   end loop Transpose_Numbers_Right_To_Left;
   ...
   Ada.Text_IO.Close 
     (File => Input_File);
end Advent_Of_Code.Y2025.Day_6.Part_2;
